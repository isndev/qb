 ...
 *
 * Comprehensive tests for exception propagation and handling in coroutines.
 * Verifies that exceptions thrown in coroutines are properly caught and
 * don't corrupt scheduler state.
 *
