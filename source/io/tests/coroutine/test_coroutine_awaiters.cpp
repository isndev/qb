/**
 * @file test_coroutine_awaiters.cpp
 * @brief Custom Awaiter Tests
 *
 * Expert-level tests for awaiter interface, custom awaiter implementations,
 * and awaiter integration with the scheduler.
 *
