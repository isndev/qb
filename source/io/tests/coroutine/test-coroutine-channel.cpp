/**
 * @file qb/io/tests/coroutine/test-coroutine-channel.cpp
 * @brief Coroutine channel communication tests
 *
 * This file contains tests for coroutine channel behavior, including buffered and
 * unbuffered send/receive operations, try_send and try_recv paths, close semantics,
 * select operations, timeouts, factories, and multi-producer scenarios.
 *
