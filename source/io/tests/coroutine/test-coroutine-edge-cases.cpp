/**
 * @file qb/io/tests/coroutine/test-coroutine-edge-cases.cpp
 * @brief Coroutine edge case and stress tests
 *
 * This file contains tests for unusual but valid coroutine usage patterns, including
 * deep nesting, rapid spawn and teardown cycles, timer edge cases, resource pressure,
 * error recovery, randomized delays, and bursty scheduling.
 *
