...
TEST_F(CryptoBasicTest, PBKDF2KeyDerivation) {
    ...
    try {
        ...
        std::vector<unsigned char> encrypted =
            qb::crypto::encrypt(test_data, derived_key_bytes, iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);

        // Decrypt with the same derived key
        std::vector<unsigned char> decrypted =
            qb::crypto::decrypt(encrypted, derived_key_bytes, iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);
        ...
        decrypted = qb::crypto::decrypt(encrypted, derived_key_repeat, iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);
...
TEST_F(CryptoBasicTest, SHA512Hash) {
    ...
    std::string expected = "13365f2c51fb536130b1cdb2da3b89968a4dbe45fc14ec786d47f0b9345faace1c1b45f23ef6ba7"
    ...
    std::string empty_expected = "cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b"
...
TEST_F(CryptoBasicTest, DigestAlgorithms) {
    ...
    std::vector<qb::crypto::DigestAlgorithm> digests = {
        qb::crypto::DigestAlgorithm::MD5,    qb::crypto::DigestAlgorithm::SHA1,   qb::crypto::DigestAlgorithm::SHA224,
...
TEST_F(CryptoBasicTest, SymmetricAlgorithms) {
    ...
    std::vector<qb::crypto::SymmetricAlgorithm> algorithms = {
        qb::crypto::SymmetricAlgorithm::AES_128_CBC,      qb::crypto::SymmetricAlgorithm::AES_192_CBC,
        qb::crypto::SymmetricAlgorithm::AES_256_CBC,      qb::crypto::SymmetricAlgorithm::AES_128_GCM,
        qb::crypto::SymmetricAlgorithm::AES_192_GCM,      qb::crypto::SymmetricAlgorithm::AES_256_GCM,
    ...
    for (auto algorithm : algorithms) {
        ...
        if (algorithm == qb::crypto::SymmetricAlgorithm::AES_128_CBC || algorithm == qb::crypto::SymmetricAlgorithm::AES_128_GCM) {
            EXPECT_EQ(key.size(), 16); // AES-128 uses 16-byte keys
        } else if (algorithm == qb::crypto::SymmetricAlgorithm::AES_192_CBC || algorithm == qb::crypto::SymmetricAlgorithm::AES_192_GCM) {
            EXPECT_EQ(key.size(), 24); // AES-192 uses 24-byte keys
        } else if (algorithm == qb::crypto::SymmetricAlgorithm::AES_256_CBC || algorithm == qb::crypto::SymmetricAlgorithm::AES_256_GCM
        ...
        if (algorithm == qb::crypto::SymmetricAlgorithm::AES_128_GCM || algorithm == qb::crypto::SymmetricAlgorithm::AES_192_GCM
            || algorithm == qb::crypto::SymmetricAlgorithm::AES_256_GCM || algorithm == qb::crypto::SymmetricAlgorithm::CHACHA20_POLY1305) {
        ...
        std::vector<unsigned char> encrypted = qb::crypto::encrypt(test_data, key, iv, algorithm);

        // Encrypted data should not be empty
        EXPECT_FALSE(encrypted.empty());

        // Decrypt
        std::vector<unsigned char> decrypted = qb::crypto::decrypt(encrypted, key, iv, algorithm);
...
TEST_F(CryptoBasicTest, ErrorHandling) {
    ...
    try {
        // Encrypt data
        std::vector<unsigned char> encrypted = qb::crypto::encrypt(test_data, key, iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);
        ...
        try {
            ...
            std::vector<unsigned char> decrypted = qb::crypto::decrypt(encrypted, wrong_key, iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);
        ...
        try {
            ...
            std::vector<unsigned char> decrypted = qb::crypto::decrypt(encrypted, key, wrong_iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);
        ...
        try {
            ...
            std::vector<unsigned char> decrypted = qb::crypto::decrypt(tampered, key, iv, qb::crypto::SymmetricAlgorithm::AES_256_GCM);
        ...
        try {
            std::vector<unsigned char> decrypted = qb::crypto::decrypt(encrypted, key, iv, qb::crypto::SymmetricAlgorithm::AES_256_CBC);
