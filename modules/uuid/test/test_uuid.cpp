...
seed_rng(EngineT &engine) {
    ...
    constexpr auto numbers_needed =
        (sizeof(device_type) < sizeof(seedseq_type)) ? (bytes_needed / sizeof(device_type)) : (bytes_needed / sizeof(seedseq_type));
...
TEST_CASE("Test iterators constructor", "[ctors]") {
    ...
    {
        uuids::uuid::value_type arr[16] = {0x47, 0x18, 0x38, 0x23, 0x25, 0x74, 0x4b, 0xfd, 0xb4, 0x11, 0x99, 0xed, 0x17, 0x7d, 0x3e, 0x43};
...
TEST_CASE("Test array constructors", "[ctors]") {
    ...
    {
        uuids::uuid guid{{0x47, 0x18, 0x38, 0x23, 0x25, 0x74, 0x4b, 0xfd, 0xb4, 0x11, 0x99, 0xed, 0x17, 0x7d, 0x3e, 0x43}};
