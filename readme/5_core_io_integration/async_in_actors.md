...
VirtualCore::__workflow__                          ← pass N
 ├─ listener::current.run(EVRUN_NOWAIT)            step 3 (VirtualCore.cpp:782)
 ├─ __flush_all__()                                step 5 (VirtualCore.cpp:795)
 └─ __receive__()                                  step 6 (VirtualCore.cpp:797)
...
Both return immediately and **share the same safety contract**, because a coroutine frame can still be running a step while — or just after — its actor is destroyed: <!-- src: qb/src/qb/core/Actor.h:1225-1241,1272,1309 -->
...
```
<!-- src: qb/src/qb/core/Actor.h:1308-1309,1809-1811, qb/src/qb/core/Actor.cpp:399-410 -->
