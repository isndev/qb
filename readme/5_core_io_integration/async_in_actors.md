...
VirtualCore::__workflow__                          ← pass N
 ├─ listener::current.run(EVRUN_NOWAIT)            step 3 (VirtualCore.cpp:808)
 ├─ __flush_all__()                                step 5 (VirtualCore.cpp:821)
 └─ __receive__()                                  step 6 (VirtualCore.cpp:823)
