...
This matches how the framework's own tests schedule delayed work, e.g. the `1ms` chained callbacks in `qb/tests/core/system/timer/async-callback-ordering.cpp:75-81`.
