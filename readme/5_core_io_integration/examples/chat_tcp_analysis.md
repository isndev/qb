...
> <!-- src: qb/src/qb/core/Actor.h:980-989 -->
...
> <!-- src: qb/src/qb/core/Actor.h:990-993 -->
...
> (`qb/src/qb/core/Actor.h:1386-1387`), and `Actor::kill()` cancels that scope
> (`qb/src/qb/core/Actor.cpp:402-413`), so the wait simply stops existing. Note that this is not a
