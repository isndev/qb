...
> <!-- src: qb/src/qb/core/Actor.h:1024-1033 -->
...
> <!-- src: qb/src/qb/core/Actor.h:1034-1037 -->
...
> (`qb/src/qb/core/Actor.h:813-816`), so on a destroyed actor the guard *is* the use-after-free.
>
> `spawn` registers the coroutine in the actor's cancellation scope
> (`qb/src/qb/core/Actor.h:1430-1431`), and `Actor::kill()` cancels that scope
