...
<!-- src: examples/01-actors/02-messaging.cpp (the shipped request/response program this section mirrors), qb/src/qb/core/Actor.cpp:114-125,168-171, qb/src/qb/core/ActorId.h:413,470-471, qb/src/qb/core/Main.h:882 -->
...
<!-- src: qb/src/qb/core/Main.cpp:594-596 (Main::core throws while running), :412-414 (Error::NoActor for a 0-actor core), qb/src/qb/core/Actor.cpp:114-125 (ctor asserts the worker thread), qb/src/qb/core/Actor.h:334-336 (onInit is where registerEvent belongs) -->
