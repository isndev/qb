...
<!-- src: qb/src/qb/core/Main.cpp:607-609 (Main::core throws while running), :425-427 (Error::NoActor for a 0-actor core), qb/src/qb/core/Actor.cpp:388-399 (ctor asserts the worker thread), qb/src/qb/core/Actor.h:471-473 (onInit is where registerEvent belongs) -->
