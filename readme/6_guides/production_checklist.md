...
<!-- src: qb/cmake/qbCompiler.cmake:372-382 (portable baseline: -march=armv8-a on non-Apple ARM64, -march=x86-64 on x86-64; Apple Silicon deliberately left alone) -->
...
<!-- src: qb/cmake/qbCompiler.cmake:400-412 (Release-only -flto + unsupported-flag warning) -->
...
<!-- src: qb/src/qb/core/Main.h:275-294 -->
...
<!-- src: qb/src/qb/core/Main.cpp:344-351 (onSignal), :631-642 (install_default_signals registers SIGINT + SIGTERM), :527 (sync start path), :549 (async start path) -->
...
<!-- src: qb/src/qb/core/Main.cpp:610-628 (install_signal incl. comment + sigaction body) -->
...
<!-- src: qb/src/qb/core/Main.cpp:673-686 (registerSignal / unregisterSignal / ignoreSignal) -->
...
<!-- src: qb/src/qb/core/Main.cpp:564-573 (stop) -->
...
<!-- src: qb/CMakePresets.json:90-106 (sanitize, sanitize-thread), qb/cmake/qbCompiler.cmake:432-441 (QB_SANITIZE applied to every qb/qbm/test target, regardless of build type) -->
...
<!-- src: qb/cmake/qbCompiler.cmake:450 (-fno-sanitize-recover=all), :442-444 (profiling-incompatibility warning) -->
