...
<!-- src: qb/cmake/qbConfig.cmake:144-152 (QB_ENABLE_NATIVE_ARCH declared OFF, with the rationale), qb/cmake/qbCompiler.cmake:364-365 (MSVC /arch:AVX2), :383-397 (-march=native, -mcpu=native fallback) -->
...
<!-- src: qb/cmake/qbCompiler.cmake:398-408 (portable baseline: -march=armv8-a on non-Apple ARM64, -march=x86-64 on x86-64; Apple Silicon deliberately left alone) -->
...
<!-- src: qb/cmake/qbConfig.cmake:153 (QB_ENABLE_FAST_MATH OFF), qb/cmake/qbCompiler.cmake:359-361 (MSVC /fp:fast), :374-380 (GCC/Clang -ffast-math) -->
...
<!-- src: qb/cmake/qbConfig.cmake:143 (QB_ENABLE_LTO OFF), qb/cmake/qbCompiler.cmake:412-440 (LTO block) -->
...
<!-- src: qb/cmake/qbCompiler.cmake:426-438 (Release-only -flto + unsupported-flag warning) -->
...
<!-- src: qb/src/qb/io/system/sys__socket.cpp:249-286 (socket::pserve), qb/src/qb/io/system/sys__socket.cpp:267-271 (the _WIN32 SO_EXCLUSIVEADDRUSE / POSIX SO_REUSEADDR fork) -->
...
<!-- src: qb/src/qb/core/Main.cpp:356-363 (onSignal), :644-655 (install_default_signals registers SIGINT + SIGTERM), :540 (sync start path), :562 (async start path) -->
...
<!-- src: qb/src/qb/core/Main.cpp:623-641 (install_signal incl. comment + sigaction body) -->
...
<!-- src: qb/src/qb/core/Main.cpp:686-699 (registerSignal / unregisterSignal / ignoreSignal) -->
...
<!-- src: qb/src/qb/core/Main.cpp:577-586 (stop) -->
...
<!-- src: qb/CMakePresets.json:105-121 (sanitize, sanitize-thread), qb/cmake/qbCompiler.cmake:458-467 (QB_SANITIZE applied to every qb/qbm/test target, regardless of build type) -->
...
<!-- src: qb/cmake/qbCompiler.cmake:476 (-fno-sanitize-recover=all), :468-470 (profiling-incompatibility warning) -->
