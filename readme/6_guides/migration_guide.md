...
_(`qb/src/qb/system/time.h:82,85,88`.)_
...
- Socket and async timeouts take `qb::duration` (for example `tcp::socket::connect(qb::io::endpoint const &ep, qb::duration wtimeout)`); a non-positive value is clamped to a single poll, not "wait forever." _(`qb/src/qb/io/tcp/socket.h:155`; `qb/source/io/src/system/sys__socket.cpp:724`.)_
