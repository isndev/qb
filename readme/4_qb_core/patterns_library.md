...
- **`ScopedCoroContext` carries the actor's id and cancellation scope.** A coroutine launched with
  ...
  (`qb/src/qb/core/Actor.h:1405`, `:1947-1951`). The context exposes the safe send surface
  ...
  (`qb/src/qb/core/Actor.h:1859-1860,1873-1875,1902-1904`). **Never capture `this` past a `co_await`** — capture by
