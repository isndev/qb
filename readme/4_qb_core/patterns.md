...
<!-- src: qb/src/qb/core/Actor.h:1249-1250,1737-1739, qb/src/qb/core/Actor.h:632-635, qb/src/qb/core/Actor.cpp:399-405, qb/src/qb/io/async/io.h:312-318,343 -->
...
- **Drive timed transitions through `spawn` + `ctx.sleep` + a self-event**, never a blocking wait and
  ...
  *evaluating the guard* is the read of freed memory. Nor is the killed-but-not-yet-reaped window the
  ...
  <!-- src: qb/src/qb/core/Actor.h:632-635, qb/src/qb/core/Actor.cpp:399-405, qb/src/qb/core/VirtualCore.cpp:820,1016 -->
...
- **Bind the deadline to the requester, do not guard it.** `spawn` runs the sleep under the actor's
  ...
  <!-- src: qb/src/qb/core/Actor.h:632-635, qb/src/qb/core/Actor.cpp:399-405 -->
