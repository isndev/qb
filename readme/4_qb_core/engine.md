...
> **Audience:** Adopter · **Status:** stable · **Verified-against:** qb 3.2.0 (C++20 default, C++23 supported) — d519f005
...
- **String literals become `std::string`** and every other argument is decayed and stored by value, because the factory has to outlive the call. Anything matching the `reference_wrapper_type` concept is preserved as-is (`src/qb/core/Actor.h:2527-2561`, `:2586-2595`).
