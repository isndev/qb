...
> **Audience:** Adopter · **Status:** stable · **Verified-against:** qb 3.2.0 (C++20 default, C++23 supported)
...
`QB_EV_LIBEVENT_COMPAT` is declared at `qb/src/qb/ev/CMakeLists.txt:103-105`.
