...
if(EXISTS "${QB_UUID_DIR}")
    ...
    if(NOT UUID_FOUND)
        ...
        if(UUID_INCLUDE_DIR AND UUID_LIBRARY)
            ...
            list(APPEND QB_EXTERNAL_LIBRARIES ${UUID_LIBRARIES})
...
if(QB_WITH_SSL)
    ...
    if(OpenSSL_FOUND)
        ...
        if(Argon2_FOUND)
            ...
            list(APPEND QB_EXTERNAL_LIBRARIES ${ARGON2_LIBRARIES})
...
if(QB_WITH_PROFILING)
    ...
    if(Gperftools_FOUND)
        ...
        list(APPEND QB_EXTERNAL_LIBRARIES ${GPERFTOOLS_LIBRARIES})
