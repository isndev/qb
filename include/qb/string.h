...
public:
    ...
    typename base_t::iterator end() noexcept {
        return base_t::begin() + _size;
    }
    typename base_t::const_iterator cend() const noexcept {
        return base_t::cbegin() + _size;
    }
    typename base_t::reverse_iterator rbegin() noexcept {
        return std::reverse_iterator(end());
    }
    typename base_t::const_reverse_iterator crbegin() const noexcept {
