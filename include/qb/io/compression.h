...
struct operation_result {
    std::size_t input_bytes_processed; // From the input buffer
    std::size_t output_bytes_produced; // To the output buffer
...
namespace gzip {
// These live in gzip.hpp because it does not need to use deps.
