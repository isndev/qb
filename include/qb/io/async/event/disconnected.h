...
struct disconnected {
    int reason =
        0; /**< Reason code for the disconnection. Common values:
            ...
            * - `-3`: Buffer size limit exceeded (DoS protection - read/write buffer exceeded `max_read_buffer_size()` or
            * `max_write_buffer_size()`) - automatic from `qb-io` Negative values are reserved for automatic error codes generated by `qb-io`.
