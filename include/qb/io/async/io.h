...
class file_watcher : public base<file_watcher<_Derived>, event::file> {
    ...
    AProtocol<_Derived> *_protocol =
        nullptr; /**< Protocol for processing file contents */
...
public:
    ...
    constexpr static const bool do_read =
        true; /**< Flag indicating that reading is enabled */
...
public:
    ...
    constexpr static const bool do_read =
        false; /**< Flag indicating that reading is disabled */
 ...
 * It combines input and output capabilities for reading from and writing to an I/O
 * source.
 *
 * @tparam _Derived The derived class type (CRTP pattern)
 */
